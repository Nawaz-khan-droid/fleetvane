...
export const theme = {
  ...
  // Cards
  card: {
    base: 'rounded-xl border shadow-sm transition-all duration-300',
    bg: 'bg-card',
    bgHover: 'hover:shadow-lg hover:-translate-y-1',
    padding: 'p-6',
    paddingLg: 'p-8',
    border: 'border-border',
    vehicleCard: 'rounded-2xl overflow-hidden border shadow-lg hover:shadow-2xl transition-all duration-500 group cursor-pointer',
  ...
  nav: {
    ...
    sidebarItemActive: 'bg-emerald-50 text-emerald-700',
    sidebarItemInactive: 'text-slate-600 hover:bg-slate-50 hover:text-slate-900',
  ...
  typography: {
    ...
    heroSubtitle: 'text-lg sm:text-xl text-slate-300 max-w-2xl',
    sectionTitle: 'text-3xl md:text-4xl font-bold text-slate-900',
    sectionSubtitle: 'text-lg text-slate-500 max-w-2xl',
